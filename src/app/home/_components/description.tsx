...
const Description = () => {
  ...
  return (
    ...
    >
      A backend developer with experience in building and managing efficient, scalable 
      server-side applications. I also have a strong interest in infrastructure and devsecops. 
      I enjoy optimizing development workflows through automation and integration while ensuring 
      the systems I build are secure and reliable throughout their lifecycle. With a deep understanding 
      of modern technologies and tools, I am committed to delivering innovative, efficient, 
